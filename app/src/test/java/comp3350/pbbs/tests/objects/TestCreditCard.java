...
public class TestCreditCard extends TestCase
{
	...
	private String card;		// card name that is user self-defined
	...
	public void testCardNum() {
		CreditCard card1 = new CreditCard(num, card, name, expMon, expYear, payDay);
		CreditCard card2 = new CreditCard(num, card, name, expMon, expYear, payDay);
		assertEquals(card1.getCardNum(), card2.getCardNum());
		card2 = new CreditCard("1000200030004000", card, name, expMon, expYear, payDay);
		assertNotEquals(card1.getCardNum(), card2.getCardNum());
		try {
			new CreditCard(null, card, name, expMon, expYear, payDay);
			fail("Expected IllegalArgumentException");
		} catch (IllegalArgumentException ignored) { }
		try {
			new CreditCard("900080007000", card, name, expMon, expYear, payDay);
			fail("Expected IllegalArgumentException");
		} catch (IllegalArgumentException ignored) { }
	}
	 ...
	 * case: a credit card name cannot be null
	 */
	public void testCardName() {
		CreditCard card1 = new CreditCard(num, card, name, expMon, expYear, payDay);
		CreditCard card2 = new CreditCard(num, card, name, expMon, expYear, payDay);
		assertEquals(card1.getCardName(), card2.getCardName());
		card2 = new CreditCard(num, "TD Bank", name, expMon, expYear, payDay);
	...
	public void testHolderName() {
		...
		card2 = new CreditCard(num, card, "Bob Bushman", expMon, expYear, payDay);
		assertNotEquals(card1.getHolderName(), card2.getHolderName());
		try {
			new CreditCard(num, card, null, expMon, expYear, payDay);
			fail("Expected IllegalArgumentException");
		} catch (IllegalArgumentException ignored) { }
		try {
			new CreditCard(num, card, "1@3?", expMon, expYear, payDay);
			fail("Expected IllegalArgumentException");
		} catch (IllegalArgumentException ignored) { }
	}
	...
	public void testExpireMonth() {
		...
		card2 = new CreditCard(num, card, name, 9, expYear, payDay);
		assertNotEquals(card1.getExpireMonth(), card2.getExpireMonth());
		try {
			new CreditCard(num, card, name, -1, expYear, payDay);
			fail("Expected IllegalArgumentException");
		} catch (IllegalArgumentException ignored) { }
		try {
			new CreditCard(num, card, name, 15, expYear, payDay);
			fail("Expected IllegalArgumentException");
		} catch (IllegalArgumentException ignored) { }
	}
	...
	public void testExpireYear() {
		...
		card2 = new CreditCard(num, card, name, expMon, expYear+1, payDay);
		assertNotEquals(card1.getExpireYear(), card2.getExpireYear());
		try {
			new CreditCard(num, card, name, expMon, -1, payDay);
			fail("Expected IllegalArgumentException");
		} catch (IllegalArgumentException ignored) { }
		try {
			new CreditCard(num, card, name, expMon, 3000, payDay);
			fail("Expected IllegalArgumentException");
		} catch (IllegalArgumentException ignored) { }
	}
	...
	public void testSpecialExpiration() {
		...
		try {
			new CreditCard(num, card, name, currMonth - 3, currYear, payDay);
			fail("Expected IllegalArgumentException");
		} catch (IllegalArgumentException ignored) { }
	}
	...
	public void testPayDate() {
		...
		card2 = new CreditCard(num, card, name, expMon, expYear, 12);
		assertNotEquals(card1.getPayDate(), card2.getPayDate());
		try {
			new CreditCard(num, card, name, expMon, expYear, -1);
			fail("Expected IllegalArgumentException");
		} catch (IllegalArgumentException ignored) { }
		try {
			new CreditCard(num, card, name, expMon, expYear, 36);
			fail("Expected IllegalArgumentException");
		} catch (IllegalArgumentException ignored) { }
	}
}
