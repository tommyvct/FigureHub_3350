...
public class TestAccessBudgetCategory extends TestCase {
	...
	// data for test
	private BudgetCategory bc1 = new BudgetCategory("restaurants", 50);
	private BudgetCategory bc2 = new BudgetCategory("Houseware", 15);
	...
	public void testValidInput() {
		...
		assertTrue(accessBudgetCategory.findBudgetCategory(bc2));
	...
	public void testInvalidLimitIntegerInput() {
		...
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "Food places", "hundred"));
		assertFalse(accessBudgetCategory.findBudgetCategory(newBC2));    // New BudgetCategory cannot be found
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "Food places", "-50"));
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "Food places", "1.234"));
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "Food places", "1,23"));
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "Food places", "1 23456"));
		assertTrue(accessBudgetCategory.findBudgetCategory(bc1)); // Old BudgetCategory can still be found
	...
	public void testInvalidLimitZeroInput() {
		...
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "Food places", "0"));
		assertFalse(accessBudgetCategory.findBudgetCategory(newBC2));    // New BudgetCategory cannot be found
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "Food places", "00"));
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "Food places", "0.0"));
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "Food places", "0.00"));
		assertTrue(accessBudgetCategory.findBudgetCategory(bc1)); // Old BudgetCategory can still be found
	...
	public void testInvalidEmptyInputBudgetLimit() {
		...
		// invalid input for limit (must be integer) while updating
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "Food places", ""));
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "Food places", " "));
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "Food places", "."));
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "Food places", null));
		assertTrue(accessBudgetCategory.findBudgetCategory(bc1)); // Old BudgetCategory can still be found
	...
	public void testInvalidEmptyInputBudgetName() {
		...
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "", "100"));
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, " ", "100"));
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, "\n", "100"));
		assertFalse(accessBudgetCategory.updateBudgetCategory(bc1, null, "100"));
		assertTrue(accessBudgetCategory.findBudgetCategory(bc1)); // Old BudgetCategory can still be found
